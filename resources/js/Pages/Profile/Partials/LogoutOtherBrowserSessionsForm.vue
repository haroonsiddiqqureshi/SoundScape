        ...
        <template #content>
            ...
            <div v-if="sessions.length > 0" class="mt-5 space-y-6">
                <div v-for="(session, i) in sessions" :key="i" class="flex items-center">
                    <div>
                        <svg v-if="session.agent.is_desktop" class="size-8 text-text-medium"
                        ...
                        <svg v-else class="size-8 text-text-medium" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-text-medium">
                                ...
                                <span v-if="session.is_current_device" class="text-secondary font-semibold">This
                                    device</span>
