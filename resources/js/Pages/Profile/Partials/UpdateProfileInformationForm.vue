    ...
    <FormSection @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                >
                    ...
                    <div
                        ...
                        class="mt-2 ml-3 font-medium text-sm text-primary"
                    >
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <label
                    class="flex items-center justify-between p-3 rounded-md w-full"
                    :class="[
                ...
                >
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p
                                ...
                                class="text-xs text-text-medium"
                            >
                    ...
                    <div class="flex items-center">
                        <input
                            v-if="user.email_verified_at"
                            type="checkbox"
                            v-model="form.notification_preferences"
                            value="email"
