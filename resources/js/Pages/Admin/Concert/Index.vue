...
// --- Add these imports (from ArtistCard.vue) ---
...
const props = defineProps({
    concerts: Object, // This is now a paginator object
    provinces: Object,
    filters: Object, // <-- Add filters prop
});

// --- Add this logic (from ArtistCard.vue) ---
// Search logic
...
watch(
    ...
    debounce((value) => {
        router.get(
            route("admin.concert.index"), // <-- Point to concert route
            { search: value },
            {
                preserveState: true,
                preserveScroll: true,
