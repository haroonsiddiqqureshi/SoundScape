            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input
                        ...
                        placeholder="e.g., Rock on The Beach 2025"
                    />
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                        placeholder="Tell us more about the concert..."
                    ></textarea>
                    <InputError
                ...
                <div>
                    ...
                    />
                    <InputError
                        :message="form.errors.start_datetime"
                        class="mt-2"
                    />
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    />
                    <InputError
                        :message="form.errors.ticket_link"
                        class="mt-2"
                    />
                </div>
            </div>
