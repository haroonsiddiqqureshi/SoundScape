    ...
    <div class="bg-card shadow-xl rounded-md p-6 space-y-2">
        ...
        <div class="flex justify-center lg:justify-end">
            <button type="submit" @click="submit" :disabled="props.form.processing"
                class="inline-flex justify-center py-1 w-full lg:px-9 shadow-sm text-sm font-semibold rounded-md text-white bg-primary hover:bg-primary-hover focus:outline-none disabled:opacity-50 transition-colors duration-150">
                Create Concert
            </button>
        </div>
    </div>
